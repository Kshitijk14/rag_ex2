...
# Combined function to calculate all scores
...
#     print("F1 Score:")
#     f1_scores = calc_f1_score(predicted, ground_truth)
#     for metric, score in f1_scores.items():
#         print(f"  {metric}: {score:.3f}")
#     print()
    
#     print("Exact Match:")
#     em_scores = calc_em_score(predicted, ground_truth)
#     for metric, score in em_scores.items():
#         print(f"  {metric}: {score:.3f}")
#     print()
    
#     print("ROUGE-L:")
#     rouge_scores = calc_rouge_l_score(predicted, ground_truth)
#     for metric, score in rouge_scores.items():
#         print(f"  {metric}: {score:.3f}")
#     print()
    
#     print("BLEU Score:")
#     bleu_scores = calc_bleu_score(predicted, ground_truth)
#     for metric, score in bleu_scores.items():
#         print(f"  {metric}: {score:.3f}")
#     print()
    
#     print("Faithfulness:")
#     faith_scores = calc_faithfulness_score(predicted, context)
#     for metric, score in faith_scores.items():
#         print(f"  {metric}: {score:.3f}")
#     print()
    
#     print("=== All Scores Combined ===")
#     all_scores = calc_all_generation_scores(predicted, ground_truth, context)
